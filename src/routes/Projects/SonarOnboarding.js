...
const SonarOnboarding = () => {
    ...
    return (
        <>
            <NavBar />
            <hr />
            <div className='project-body-title' data-aos="fade-up">
            ...
            <div className='project-body'>
                ...
                <section data-aos="fade-up">
                    ...
                    <p>We understand how important a first impression is. That's why my team and I focused on redesigning the onboarding experience. Our goal was to make it feel more personal, intuitive, and emotionally supportive.</p>
                </section>
                <section data-aos="fade-up">
                ...
                <section data-aos="fade-up">
                    <h2>Sketches</h2>
                    <p>Before creating a hi-fi mockup, I started with quick sketches to explore different layout ideas and interaction flows. This allows me to put my brainstorm ideas, understand the big picture, get feedback from my team, and flesh out my ideas before pursuing a hi-fi prototype. Sketches will be uploaded soon.</p>
                </section>
                <section data-aos="fade-up">
                    <h2>Prototype #1</h2>
                    ...
                    <div className="flex-row-container">
                        <img src={prototype1f1} alt="Prototype #1 Welcome Page"/>
                        <img src={prototype1f2} alt="Prototype #1 Conversation"/>
                        <img src={prototype1f3} alt="Prototype #1 Conversation"/>
                    </div>
                </section>
                <section data-aos="fade-up">
