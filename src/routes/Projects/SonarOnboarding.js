        ...
        <>
            ...
            <div className='project-body'>
                ...
                <section data-aos="fade-up">
                    ...
                    <p>The prototype was tested on a small sample size, which may not fully capture Sonar’s diverse user base. While we conducted a few interviews from external sources, time constraints, and legal procedures necessary to interview local high school students in Irvine prevented us from gathering as many outside interviewees as we’d hoped.  Additionally, I was familiar with Figma prototyping but lacked enough UI design experience. This meant that designing components and wireframing was a bit of a learning curve. Lastly, the interviews occurred virtually on Zoom, which limited my ability to observe non-verbal cues and assess how interviewees interacted with the prototypes.</p>
                    <p>If I were to continue this project into the future, I would expand user testing to a larger and more diverse group of people, like local schools and university outreach programs. I would also like to reach out to people who specifically have struggled with their mental health to get specific insights on their experience with the Sonar app. Secondly, I would work with Sonar’s development team to refine and fully integrate the onboarding redesign into the upcoming app. I’m also interested in exploring additional features beyond just the ability to chat with a person, such as a mood tracker, mental health resources, and minigames.</p>
                </section>
            </div>
        </>
    )
